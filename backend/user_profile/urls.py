...
from .views import EditUserProfile, GetLoggedinUser, UserFollowViews,UserdetailView, UserProfileView, ToggleBookmarkViews, PostBookmarkVew, RecomendedUser, MutualFeiend
